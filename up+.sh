...
if [ -f /home/erik/ARCO/ARCOLINUX/sofirem/usr/share/sofirem/cache/yaml-packages ]; then
	sudo rm -v /home/erik/ARCO/ARCOLINUX/sofirem/usr/share/sofirem/cache/yaml-packages.lst
fi
